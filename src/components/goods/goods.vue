    ...
    <div class="foods-wrapper" ref='foodsWrapper'>
      <ul>
        <li v-for='item in goods' class='food-list' ref='foodList'>
          ...
          <ul>
            <li v-for='(food,i) in item.foods' class='food-item border-1px' @click='selectFood(food,$event)'>
              <div class='icon'>
              ...
              <div class='content'>
                ...
                <div class="cartcontrol-wrapper">
                  <cartcontrol @add.stop='addFood' :food='food'></cartcontrol>
                </div>
              </div>
            </li>
          </ul>
...
<style lang='stylus' rel='stylesheet/stylus'>
  ...
  .goods
    display: flex
    position: absolute
    /*为什么是174 因为上面174px被头部和tab栏占了*/
    top: 174px
    bottom: 46px
    width: 100%
    overflow: hidden
    .menu-wrapper
      /*第一个参数是占多少份 第二个是内容不足的时候的缩放情况 第三个是占位的空间*/
      flex: 0 0 80px
      width: 80px
      background: #f3f5f7
      .menu-item
